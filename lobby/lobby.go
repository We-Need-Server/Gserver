...
func (l *Lobby) ReadyTcp() (*internal.TcpReceiver, *internal.TcpSender) {
	...
	l.tcpReceiver = internal.NewTcpReceiver(tcpLn, l.userDb.Login, l.userDb.BlueTeamDb, l.userDb.RedTeamDb, l.communicateTcpSender, l.matchScore, l.listenUdpAddr, l.gameManager.StartGameManager, &l.gameManager.GameStatus, l.gameManager.SendGameInitPacket)
